...
static_assert(RegExSyntaxFlags_no_mod_m == (int)boost::regex_constants::no_mod_m);
static_assert(RegExSyntaxFlags_mod_x == (int)boost::regex_constants::mod_x);
static_assert(RegExSyntaxFlags_mod_s == (int)boost::regex_constants::mod_s);
static_assert(RegExSyntaxFlags_no_mod_s == (int)boost::regex_constants::no_mod_s);
...
static_assert(RegExMatchFlag_not_bob == (int)boost::regex_constants::match_not_bob);
static_assert(RegExMatchFlag_not_eob == (int)boost::regex_constants::match_not_eob);
