...
namespace RegExTests
{
    ...
    public:
        ...
        TEST_METHOD(BasicMatch_Utf8)
        {
            ...
            HRESULT hr = regex->EnumerateMatches(inputBytes, RegExCodePage_utf8, 0, RegExMatchFlag_default, enumerator.put());
        ...
        TEST_METHOD(Utf16_Turkish)
        {
            ...
            Assert::AreEqual(S_OK, regex_i->EnumerateMatches(inputBytes_idot, RegExCodePage_utf16le, 0, RegExMatchFlag_default, enum_idot.put()));
            ...
            Assert::AreEqual(S_OK, regex_i->EnumerateMatches(inputBytes_I, RegExCodePage_utf16le, 0, RegExMatchFlag_default, enum_I.put()));
            ...
            Assert::AreEqual(S_OK, regex_I->EnumerateMatches(inputBytes_dotless, RegExCodePage_utf16le, 0, RegExMatchFlag_default, enum_dotless.put()));
            ...
            Assert::AreEqual(S_OK, regex_I->EnumerateMatches(inputBytes_latin_i, RegExCodePage_utf16le, 0, RegExMatchFlag_default, enum_latin_i.put()));
        ...
        TEST_METHOD(Utf16LE_Match)
        {
            ...
            wil::com_ptr<IRegExMatchEnumerator> enumerator;
            regex->EnumerateMatches(inputBytes, RegExCodePage_utf16le, 0, RegExMatchFlag_default, enumerator.put());
        ...
        TEST_METHOD(StartByteOffset_SkipsEarlierContent)
        {
            ...
            wil::com_ptr<IRegExMatchEnumerator> enumerator;
            HRESULT hr = regex->EnumerateMatches(inputBytes, RegExCodePage_utf8, 5, RegExMatchFlag_default, enumerator.put());
            Assert::AreEqual(S_OK, hr);
        ...
        TEST_METHOD(StartByteOffset_MatchesAtOffset)
        {
            ...
            wil::com_ptr<IRegExMatchEnumerator> enumerator;
            HRESULT hr = regex->EnumerateMatches(inputBytes, RegExCodePage_utf8, 6, RegExMatchFlag_default, enumerator.put());
            Assert::AreEqual(S_OK, hr);
        ...
        TEST_METHOD(StartByteOffset_InvalidMidSequence_Utf8)
        {
            ...
            wil::com_ptr<IRegExMatchEnumerator> enumerator;
            HRESULT hr = regex->EnumerateMatches(inputBytes, RegExCodePage_utf8, 1, RegExMatchFlag_default, enumerator.put());
            Assert::AreEqual(E_INVALIDARG, hr);
            Assert::IsNull(enumerator.get());
        }
        ...
        TEST_METHOD(StartByteOffset_InvalidMidSequence_Utf16)
        {
            ...
            wil::com_ptr<IRegExMatchEnumerator> enumerator;
            HRESULT hr = regex->EnumerateMatches(inputBytes, RegExCodePage_utf16le, 2, RegExMatchFlag_default, enumerator.put());
            Assert::AreEqual(E_INVALIDARG, hr);
            Assert::IsNull(enumerator.get());
        }
        ...
        TEST_METHOD(StartByteOffset_OddByteOffset_Utf16)
        {
            ...
            wil::com_ptr<IRegExMatchEnumerator> enumerator;
            HRESULT hr = regex->EnumerateMatches(inputBytes, RegExCodePage_utf16le, 1, RegExMatchFlag_default, enumerator.put());
            Assert::AreEqual(E_INVALIDARG, hr);
            Assert::IsNull(enumerator.get());
        }
