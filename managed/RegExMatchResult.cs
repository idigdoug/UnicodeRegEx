namespace UnicodeRegEx
{
    ...
    /// <summary>
    /// The outcome of a single <see cref="RegEx.Match(RegExPinnedBytes, int, RegExMatchOptions)"/> or
    /// <see cref="RegEx.Search(RegExPinnedBytes, int, RegExMatchOptions)"/> call. Must be disposed.
    /// </summary>
